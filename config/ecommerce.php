    ...
    'paypal'       =>
        [
            'paypal_1' => [
                ...
                'paypal_api_signature'                 => env('PAYPAL_API_SIGNATURE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AzicGtaPYWDX3BZv1bFgMmU9D5mv'),
                ...
                'paypal_api_checkout_redirect_url'     => env('PAYPAL_API_CHECKOUT_REDIRECT_URL', 'https://www.sandbox.paypal.com/checkoutnow/2?useraction=commit&token='),
                'paypal_api_checkout_return_url'       => env('PAYPAL_API_CHECKOUT_RETURN_URL', 'http://dev.drumeo.com/laravel/public/order-form/handle-paypal-redirect'),
                'paypal_api_checkout_cancel_url'       => env('PAYPAL_API_CHECKOUT_CANCEL_URL', 'http://dev.drumeo.com/laravel/public/paypal-for-railcenter/cancel'),
