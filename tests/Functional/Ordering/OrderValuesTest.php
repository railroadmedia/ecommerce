...
//            'shipping_country' => $country,
    ...
    public function test_basic_order_with_taxes_with_shipping_with_payment_plan_alberta()
    {
        ...
        // 0.20
        $financeDuePerPayment = round($financeCosts/$numberOfPayments, 2);

        $paymentPlanCostPerPayment = round(($productCost) / $numberOfPayments, 2); // 20.2
        $paymentPlanCostPerPaymentAfterTax = round(($paymentPlanCostPerPayment * (1+$productTaxRate)), 2); // 21.20

        $paymentPlanCostPerPayment += $financeDuePerPayment;
        $paymentPlanCostPerPaymentAfterTax += $financeDuePerPayment;
        ...
        $this->assertEquals(31.70, $initialPaymentAmount);
        $this->assertEquals(
            $grandTotalDue,
            ($initialPaymentAmount + round($paymentPlanCostPerPaymentAfterTax * 4, 2))
        );
    ...
    public function test_basic_order_with_taxes_with_shipping_with_payment_plan_bc()
    {
        ...
        $this->assertEquals(33.10, $initialPaymentAmount);
        $this->assertEquals(
            $grandTotalDue,
            ($initialPaymentAmount + round($paymentPlanCostPerPaymentAfterTax * 4, 2))
        );
    ...
    public function test_basic_order_with_taxes_with_shipping_with_payment_plan_bc_simulate_renewals()
    {
        ...
        $costPerPaymentBeforeTaxes = round(($productCost) / $numberOfPayments, 2); // 20.20
    ...
    public function test_basic_order_with_taxes_with_shipping_with_payment_plan_bc_simulate_renewals_uneven_split()
    {
        ...
        $this->assertEquals(33.33, $initialPaymentAmount);
    ...
    public function test_basic_order_with_taxes_with_payment_plan_bc_simulate_renewals_uneven_split_4()
    {
        $productCost = 59.00;
        $shippingCost = 0;
        $country = 'Canada';
        ...
        $this->assertEquals(12.59, $initialPaymentAmount);
        ...
        $product = $this->newProduct(Product::TYPE_DIGITAL_ONE_TIME, $productCost, 0);
