...
class OrderFormSubmitRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        {
            $rules += [
                'shipping-address-id'     => 'required_without_all:shipping-first-name,shipping-last-name,shipping-address-line-1,shipping-city,shipping-region,shipping-zip-or-postal-code,shipping-country|exists:' . ConfigService::$databaseConnectionName . '.' .ConfigService::$tableAddress . ',id',
