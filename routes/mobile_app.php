...
Route::group(
    ...
    function () {
        ...
        Route::post(
            ...
            Railroad\Ecommerce\Controllers\AppleStoreKitController::class . '@processReceipt'
        )
        ...
        Route::post(
            '/api/apple/restore',
            Railroad\Ecommerce\Controllers\AppleStoreKitController::class . '@restorePurchase'
        )
            ->name('apple_store_kit.restore');

        Route::post(
            '/google/verify-receipt-and-process-payment',
            Railroad\Ecommerce\Controllers\GooglePlayStoreController::class . '@processReceipt'
        )
        ...
        Route::post(
            '/api/google/restore',
            Railroad\Ecommerce\Controllers\GooglePlayStoreController::class . '@restorePurchase'
        )
...
Route::group(
    ...
    function () {
        Route::post(
            ...
            Railroad\Ecommerce\Controllers\AppleStoreKitController::class . '@processNotification'
        )
            ->name('apple_store_kit.verify_receipt');

        Route::post(
            '/google/handle-server-notification',
            Railroad\Ecommerce\Controllers\GooglePlayStoreController::class . '@processNotification'
        )
